...
function parseSpeed(speed)
  ...
  elseif speed == "supersonicstyle" then return 0.000000000000000000000000001
  elseif speed == "medium" then return 0.04
  elseif speed == "slow" then return 0.08
  elseif speed == "1framepersecond" then return 9000
  else
...
function Talkies.say(title, messages, config, dt)
  config = config or {}
...
function Talkies.update(dt)
  ...
  if currentMessage == nil then return end
...
function Talkies.prevOption()
  ...
  if currentMessage == nil or not currentMessage:showOptions() then return end
end
